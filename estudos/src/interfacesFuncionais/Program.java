...
public class Program {
	...
	public static void main(String[] args) {
		...
		// mf - filteredSum faz a soma dos valores dos produtos,  ao receber uma lista de prod e um predicado;
		System.out.println("Soma pelo método = " + String.format("%.2f", MyFunction.filteredSum(lista, p -> p.getPrice() < 100)));
	}
